...
void SceneUI::start() {
    ...
    pickingShader = new Shader ("E:\\VISUAL STUDIO\\GoldEngine2D\\source\\Components\\Systems\\pickvert.glsl",
                                "E:\\VISUAL STUDIO\\GoldEngine2D\\source\\Components\\Systems\\pickfrag.glsl");
...
void SceneUI::draw() {
    glUniform4f(pickingShader->ID, Red / 255.0f, Green / 255.0f, Blue / 255.0f, 1.0f);
    pickingShader->use();
